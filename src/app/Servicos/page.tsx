...
const Servicos = () => {
  ...
  if (isLoading) return <div className="container mx-auto px-4 py-8 text-center">Carregando serviços...</div>;
  if (isError) return <div className="container mx-auto px-4 py-8 text-center text-red-500">Erro ao carregar serviços: {error.message}</div>;
